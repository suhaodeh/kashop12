...
namespace KASHOP12.DAL.Migrations
{
    ...
    [Migration("20260202174620_addPaymentStatusToOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KASHOP12.DAL.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("KASHOP12.DAL.Models.Cart", b =>
                {
            ...
            modelBuilder.Entity("KASHOP12.DAL.Models.OrderItem", b =>
                {
                    b.HasOne("KASHOP12.DAL.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("KASHOP12.DAL.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
